...
///
/// Generates its own span ID; the trace ID comes from [parentContext] when
/// given (this span joins that trace), or is freshly generated if this is a
/// root span. [end] snapshots this span as a [SpanData] and hands it to
/// [processor]; calling [end] more than once is a safe no-op.
class SdkSpan implements Span {
  ...
  /// The instrumentation scope (tracer) name/version this span was created
  /// under.
